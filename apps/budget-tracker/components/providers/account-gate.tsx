 ...
 *
 * No app-data requests fire until access is `ready` (the api-client reads the
 * active account from the store, only set on `ready`; the budget store also
 * initialises inside the gate).
 */
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center p-6">
        <div className="max-w-md text-center">
          <div className="size-14 rounded-xl bg-muted flex items-center justify-center mx-auto mb-4">
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center p-6">
        <div className="max-w-md text-center">
          ...
          <h1 className="text-lg font-semibold text-foreground mb-1">No access to Budget Tracker</h1>
          <p className="text-sm text-muted-foreground">
            You don&apos;t have access to any Budget Tracker account. Access arrives by invitation —
