...
export function applyRules(
  ...
  customRules?: Array<{ pattern: string; matchType: string; category: string; subcategory: string; enabled: boolean; isIgnore?: boolean; overridesBuiltinId?: string }>
): { category: string; subcategory: string; ruleId: string; isIgnore?: boolean } | null {
