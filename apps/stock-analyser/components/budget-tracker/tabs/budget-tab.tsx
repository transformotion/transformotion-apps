  ...
  const confirmDelete = () => {
    ...
    if (deleteModal.kind === "subcategory") {
      ...
      if (deleteModal.count > 0) {
        const updated = transactions.map(t =>
          t.subcategory === subcategory
            ? { ...t, subcategory: deleteTransferTo || undefined, category: deleteTransferTo ? t.category : undefined, _manual: !!deleteTransferTo }
            : t
        )
      ...
      if (deleteModal.count > 0) {
        const updated = transactions.map(t =>
          t.category === category
            ? { ...t, category: deleteTransferTo || undefined, subcategory: undefined, _manual: !!deleteTransferTo }
            : t
        )
        setTransactions(updated)
      }
