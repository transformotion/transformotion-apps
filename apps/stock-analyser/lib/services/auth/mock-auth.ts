 ...
 * Replace with CognitoAuthService for production.
 */

import { AuthService, User, Account, AuthSession, AuthTokens, SignInCredentials, SignUpCredentials } from './index'
...
export class MockAuthService implements AuthService {
  ...
  async signUp(credentials: SignUpCredentials): Promise<AuthSession> {
    // Mock: create user from credentials
    this.session = {
      user: {
        ...MOCK_USER,
...
// Singleton instance
let _authService: MockAuthService | null = null
